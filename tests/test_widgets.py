...
class TestParameterSlider:
    ...
    def test_initialization(self, qapp, qtbot):  # noqa: ARG002
    ...
    def test_value_change(self, qapp, qtbot):  # noqa: ARG002
...
class TestPlaybackControls:
    ...
    def test_play_button_toggle(self, qapp, qtbot):  # noqa: ARG002
    ...
    def test_volume_signal(self, qapp, qtbot):  # noqa: ARG002
...
class TestWaveformDisplay:
    ...
    def test_set_audio_data(self, qapp, qtbot, test_audio, sample_rate):  # noqa: ARG002
    ...
    def test_playback_position(self, qapp, qtbot):  # noqa: ARG002
    ...
    def test_clear(self, qapp, qtbot, test_audio, sample_rate):  # noqa: ARG002
