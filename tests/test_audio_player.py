...
class TestAudioPlayer:
    ...
    def test_initialization(self, player: AudioPlayer, processor: AudioProcessor) -> None:
    ...
    def test_set_loop_region(self, player: AudioPlayer, processor: AudioProcessor) -> None:
    ...
    def test_get_loop_region(self, player: AudioPlayer, processor: AudioProcessor) -> None:
